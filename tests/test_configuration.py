...
from vision.servicenode.configuration import _DEFAULT_FILE_NAME
...
from vision.servicenode.configuration import get_plugin_config
from vision.servicenode.configuration import get_signer_config
...
def test_load_config_correct():
    ...
    with unittest.mock.patch('vision.servicenode.configuration.config',
                             config_mock):
...
@unittest.mock.patch('vision.servicenode.configuration.get_blockchain_config')
