...
def read_node_health_data(blockchain: Blockchain) -> NodesHealth:
    ...
    ----------
    blockchain : Blockchain
        The blockchain for which the health data is read.

    Returns
    -------
    NodesHealth
        The node health data.
...
def create_transfer(source_blockchain: Blockchain,
    ...
    hub_address : str
        The address of the Vision Hub contract on the token transfer's
        source blockchain.
    forwarder_address : str
        The address of the Vision Forwarder contract on the token
...
def update_on_chain_transfer_id(internal_transfer_id: int,
    ...
    on_chain_transfer_id : int
        The Vision transfer ID assigned by the Vision Hub contract on
